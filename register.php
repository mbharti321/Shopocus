...
<body>
	...
	<div id="background">
		...
		<div id="loginContainer">
			<center><h1>Welcome to Shopocus!</h1></center>
			...
			<div id="loginText">
				<h1>Get great shopping exprience, right now</h1>
				<h2>Shop for the best product out there</h2>
				<ul>
					<li>Claim great discount!!</li>
					<li>Take home fresh veggies and groceries</li>
